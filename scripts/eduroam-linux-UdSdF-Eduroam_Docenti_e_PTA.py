...
Messages.cat_dir_exists = "Directory {} exists; some of its files may " \
    "be overwritten"
Config.instname = "Università degli Studi di Ferrara"
Config.profilename = "Eduroam Docenti e PTA"
Config.url = "la pagina del tuo supporto locale eduroam®"
Config.email = "helpdesk@unife.it"
Config.title = "eduroam CAT"
Config.server_match = "radius.unife.it"
...
Config.init_confirmation = "Questo programma di installazione " \
    ...
    "utenti: {1}."
Config.user_realm = "unife.it"
Config.ssids = ['eduroam']
Config.del_ssids = []
Config.servers = ['DNS:radius.unife.it']
Config.use_other_tls_id = False
Config.anonymous_identity = "anonymous@unife.it"
Config.tou = ""
